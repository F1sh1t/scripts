...
function library:Window(name) 
    ...
    UiWindow.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
    UiWindow.BorderColor3 = Color3.fromRGB(20, 20, 20)
    ...
    Header.BackgroundColor3 = Color3.fromRGB(255, 166, 0)
    Header.BorderColor3 = Color3.fromRGB(201, 131, 0)
    ...
    Window.BorderColor3 = Color3.fromRGB(150, 0, 237)
    ...
    function functions:Toggle(text, on, callback)
        ...
        ToggleFiller.BackgroundColor3 = Color3.fromRGB(255, 162, 48)
        ToggleFiller.BorderColor3 = Color3.fromRGB(255, 162, 48)
